...
#ifndef BIPEDAL_LOCOMOTION_DILIGENT_H
#define BIPEDAL_LOCOMOTION_DILIGENT_H
 ...
 *
 */
class DILIGENT : public FloatingBaseEstimator
{
public:
    /**
     * Constructor
...
#endif // BIPEDAL_LOCOMOTION_DILIGENT_H
